...
for event in longpoll.listen():
	if event.type == VkEventType.MESSAGE_NEW and event.from_user and event.to_me: #Если вас НЕ будут волновать документы, фотки видео и тд, то также пропишите:'and event.text'
